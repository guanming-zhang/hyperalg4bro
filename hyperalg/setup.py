...
cxx_files = ["hyperalg/distances/_get_distance_cpp.cxx",
        "hyperalg/distances/_put_in_box_cpp.cxx",
        "hyperalg/distances/_check_overlap.cxx",
        "hyperalg/potentials/collective_coordinates.cxx",
        "hyperalg/potentials/hertzian_potential.cxx",
        "hyperalg/potentials/inversepower_potential.cxx",
        "hyperalg/potentials/wca_potential.cxx",
        "hyperalg/potentials/explicit_sk_potential.cxx",
        "hyperalg/utils/c_utils.cxx",
             ]
