#ifndef _HYPERALG_WCA_HPP
#define _HYPERALG_WCA_HPP
...
class WCA : public ha::SimplePairwisePotential<ha::WCA_interaction, ha::cartesian_distance<ndim>> {
public:
    WCA(double sig, double eps, const std::vector<double> radii)
        : SimplePairwisePotential< ha::WCA_interaction, ha::cartesian_distance<ndim>>(
                std::make_shared<ha::WCA_interaction>(sig, eps),
 ...
 */
template<size_t ndim>
class WCAPeriodic : public ha::SimplePairwisePotential<ha::WCA_interaction, ha::periodic_distance<ndim> > {
public:
    WCAPeriodic(double sig, double eps, const std::vector<double> radii, const std::vector<double> boxvec)
        : SimplePairwisePotential<ha::WCA_interaction, ha::periodic_distance<ndim>> (
                std::make_shared<ha::WCA_interaction>(sig, eps),
...
template <size_t ndim>
class WCAPeriodicCellLists : public CellListPotential< ha::WCA_interaction, ha::periodic_distance<ndim> > {
public:
    ...
    WCAPeriodicCellLists(double sigma, double eps,
        ...
        : CellListPotential< ha::WCA_interaction, ha::periodic_distance<ndim> >
        (std::make_shared<ha::WCA_interaction>(sigma, eps),
