#ifndef HYPERALG_POINT_PATTERN_STATISTICS_HPP
#define HYPERALG_POINT_PATTERN_STATISTICS_HPP
...
protected:
    ...
    Moments m_moments;
    ha::periodic_distance<m_ndim> m_distance;
