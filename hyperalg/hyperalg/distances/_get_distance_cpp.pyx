...
cdef extern from "hyperalg/distance.hpp" namespace "ha":
    cdef cppclass cppCartesianDistance "ha::cartesian_distance"[ndim]:
    ...
    cdef cppclass cppPeriodicDistance "ha::periodic_distance"[ndim]:
