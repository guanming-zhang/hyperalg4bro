...
cdef extern from "hyperalg/invpowlogi_potential.hpp" namespace "ha":
    cdef cppclass cppInvPowLogiCartesian "ha::InvPowLogiCartesian"[ndim]:
        cppInvPowLogiCartesian(double, double, double, vector[double]&) except +
    cdef cppclass cppInvPowLogiPeriodic "ha::InvPowLogiPeriodic"[ndim]:
        cppInvPowLogiPeriodic(double, double, double, vector[double]&, vector[double]&) except +
    cdef cppclass cppInvPowLogiPeriodicCellLists "ha::InvPowLogiPeriodicCellLists"[ndim]:
        cppInvPowLogiPeriodicCellLists(double, double, double, vector[double]&, vector[double]&, double, bint) except +
    cdef cppclass cppInvPowLogiPeriodicBatchCellLists "ha::InvPowLogiPeriodicBatchCellLists"[ndim]:
        cppInvPowLogiPeriodicBatchCellLists(double, double, double, vector[double]&, vector[double]&, double, bint) except +
