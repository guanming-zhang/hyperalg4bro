...
cdef extern from "hyperalg/bro_potential.hpp" namespace "ha":
    cdef cppclass cppBroPeriodicCellLists "ha::BroPeriodicCellLists"[ndim]:
        cppBroPeriodicCellLists(double, double, vector[double]&, vector[double]&, int, double, bint) except +
    cdef cppclass cppBroPeriodicBatchCellLists "ha::BroPeriodicBatchCellLists"[ndim]:
        cppBroPeriodicBatchCellLists(double, double, vector[double]&, vector[double]&, int, double, bint) except +
